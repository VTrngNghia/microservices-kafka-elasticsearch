...
public class TwitterAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse(
		"{\"type\":\"record\",\"name\":\"TwitterAvroModel\",\"namespace\":\"com.microservices.demo.kafka.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"text\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");

	@Serial
	private static final long serialVersionUID = 7195114595446043491L;
	 ...
	 * given SchemaStore
	 */
	public static BinaryMessageDecoder<TwitterAvroModel> createDecoder(
		SchemaStore resolver
	) {
		return new BinaryMessageDecoder<TwitterAvroModel>(
			MODEL$,
			SCHEMA$,
			resolver
		);
	 ...
	 */
	public static com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder newBuilder(
		com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder other
	) {
		if (other == null) {
			return new com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder();
		} else {
	 ...
	 */
	public static com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder newBuilder(
		com.microservices.demo.kafka.avro.model.TwitterAvroModel other
	) {
		if (other == null) {
			return new com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder();
		} else {
		...
		implements org.apache.avro.data.RecordBuilder<TwitterAvroModel>
	{
		 ...
		 * @return This builder.
		 */
		public com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder setId(
			long value
		) {
		 ...
		 * @return This builder.
		 */
		public com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder setUserId(
			long value
		) {
		 ...
		 * @return This builder.
		 */
		public com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder setText(
		 ...
		 * @return This builder.
		 */
		public com.microservices.demo.kafka.avro.model.TwitterAvroModel.Builder setCreatedAt(
		...
		public TwitterAvroModel build() {
			try {
				...
				record.id = fieldSetFlags()[0] ? this.id : (java.lang.Long) defaultValue(
					fields()[0]);
				record.userId = fieldSetFlags()[1] ? this.userId : (java.lang.Long) defaultValue(
					fields()[1]);
				record.text = fieldSetFlags()[2] ? this.text : (java.lang.String) defaultValue(
					fields()[2]);
				record.createdAt = fieldSetFlags()[3] ? this.createdAt : (java.lang.Long) defaultValue(
					fields()[3]);
				return record;
